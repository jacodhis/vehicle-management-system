    ...
    <div class="login-box">
        <form class="login-form" action="{{ route('admin.login.post') }}" method="POST" role="form">
            ...
            <div class="form-group">
                <label class="control-label" for="username">User Name or Email Address</label>
                <input class="form-control" type="username" id="username" name="username" placeholder="username address" autofocus value="{{ old('username') }}">
            </div>
            <div class="form-group">
