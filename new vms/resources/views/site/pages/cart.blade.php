    ...
    <section class="section-content bg padding-y border-top">
        <div class="container">
            ...
            <div class="row">
                <main class="col-sm-9">
                    @if (\Cart::isEmpty())
                        <p class="alert alert-warning">Your booking cart is empty.</p>
                    @else
                        <div class="card">
                ...
                <aside class="col-sm-3">
                    ...
                    <a href="{{ route('checkout.index') }}" class="btn btn-success btn-lg btn-block"><i><img src="{{ asset('frontend/images/icons/paypal.png') }}"></i>  Checkout with Paypal</a>
                    <a href="{{ route('checkout.mpesa') }}" class="btn btn-success btn-lg btn-block"><i><img src="{{ asset('frontend/images/icons/mpesa.jpg') }}"></i>  Checkout with M-pesa</a>
                </aside>
            </div>
        </div>
    </section>
