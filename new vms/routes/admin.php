...
Route::group(['prefix'  =>  'admin'], function () {
    ...
    Route::group(['middleware' => ['auth:admin']], function () {
        ...
        Route::group(['prefix' => 'booking'], function () {
           Route::get('/', 'Admin\OrderController@bookingindex')->name('admin.booking.index');
           Route::get('/{order}/show', 'Admin\OrderController@bookingshow')->name('admin.booking.show');
           Route::post('aairtime{id}','Admin\OrderController@approved');
        });

        Route::group(['prefix' => 'feedback'], function () {
           Route::get('/', 'Admin\OrderController@feedbackindex')->name('admin.feedback.index');
           Route::get('/{order}/show', 'Admin\OrderController@feedbackshow')->name('admin.feedback.show');
           // Route::post('aairtime{id}','Admin\OrderController@approved');
        });
